...
const DonationForm = ({ theme }) => {
  ...
  return (
    <Box sx={{ display: "flex" }}>
      ...
      <Box>
        <Typography sx={{ color: theme.palette.text.dark }} variant="body1">
          Neste formulário você faz uma doação única, através de boleto, pix ou
          cartão, caso queira ser um doador recorrente, selecione a opção acima
          e faça seu cadastro.
        </Typography>
        <form
          style={{
